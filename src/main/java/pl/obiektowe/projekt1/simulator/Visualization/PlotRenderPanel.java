...
public class PlotRenderPanel extends JPanel {
    ...
    public PlotRenderPanel(EvolutionSimulatorMap map, MapSimulation simulation) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        animalsPopulation.add(map.getAnimalList().size());
        grassPopulation.add(map.getPlants().size());
